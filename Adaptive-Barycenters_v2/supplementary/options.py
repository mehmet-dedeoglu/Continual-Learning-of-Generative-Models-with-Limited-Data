...
class Options(object):
    ...
    def parse(self):
        ...
        parser.add_argument('--instruction_input', type=str, default='Instructions.txt')
        ...
        # data
        parser.add_argument('--data', type=str, choices=['4gaussians', 'swissroll', 'checkerboard'], default='4gaussians')
