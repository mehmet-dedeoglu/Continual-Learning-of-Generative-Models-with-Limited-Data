...
if __name__ == '__main__':
    ...
    if not os.path.exists(string_fid):
        ...
        for it in range_array:
            ...
            real_path = 'CIFAR_Simulations/Folder_Transfer_Full104/FID_Images/Iteration_' + str(iterations[it]) \
                        + '/Real_Images'
            # real_path = 'CIFAR100_Simulations/Folder_EdgeOnly_Too_Long[0, 1, 2, 3, 4]Full/FID_Images' + '/Iteration_' + str(iterations[it]) + '/Real_Images'
