...
def parse_args():
    ...
    parser.add_argument('--epoch_num', type=int, default=8001)
    ...
    parser.add_argument('--data_folder', type=str, default='CIFAR100_data')  # CIFAR100_Sample, CIFAR100_data
...
def parse_args_eval():
    ...
    parser.add_argument('--checkpoint_path', type=str,
                        default='CIFAR100_Simulations/Folder_[0, 1, 2, 3, 4]/checkpoint_Iter_9')
...
def parse_args_fid():
    ...
    parser.add_argument('--folder_path', type=str,
                        default='CIFAR_Simulations/Folder_Aggregate_Too_Long[0, 1, 2, 3, 4][95, 96, 97, 98]Full107/FID_Images')
